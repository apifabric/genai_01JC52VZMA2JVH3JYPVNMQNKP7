...
@Component({
  selector: 'CarModel-home',
  templateUrl: './CarModel-home.component.html',
  styleUrls: ['./CarModel-home.component.scss']
})
export class CarModelHomeComponent implements AfterViewInit {

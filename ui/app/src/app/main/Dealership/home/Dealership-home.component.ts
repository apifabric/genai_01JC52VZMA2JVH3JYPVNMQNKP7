...
@Component({
  selector: 'Dealership-home',
  templateUrl: './Dealership-home.component.html',
  styleUrls: ['./Dealership-home.component.scss']
})
export class DealershipHomeComponent implements AfterViewInit {
